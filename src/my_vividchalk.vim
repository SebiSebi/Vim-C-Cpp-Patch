" [Sebi] Edited only for terminal"
" When calling s:hifg only the 4th parameter counts - it's for terminal
" The third one is for gui.
...
highlight LineNr        guifg=#DDEEFF ctermfg=Black
call s:hibg("LineNr"    ,"#222222","DarkBlue",7)
...
call s:hifg("Comment"        ,"#9933CC","Green",44) " 92
" 26 instead?
...
call s:hifg("Type"           ,"#AAAA77","Blue",23) " 101
call s:hifg("railsUserClass" ,"#AAAAAA","Blue",23) " 101
